...
results_df <- data.frame(array(NA, dim = c(length(slim_out_files),16), dimnames = list(c(),c("m","reps","seed", "Heterozygosity_genomewide","p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10", "dxy", "Fst"))))
